...
UIkit 2.27.2 by (c) 2014 YOOtheme
...
1. spectrumstarter_before_site_header
2. spectrumstarter_before_site_header_inside
3. spectrumstarter_spectrumstarter_after_site_header_inside
4. spectrumstarter_after_site_header
5. spectrumstarter_before_header_image
6. spectrumstarter_after_header_image
7. spectrumstarter_before_index_content_starts
8. spectrumstarter_after_index_content_starts
9. spectrumstarter_before_category_content_starts
10. spectrumstarter_after_category_content_ends
11. spectrumstarter_before_tag_content_starts
12. spectrumstarter_after_tag_content_ends
13. spectrumstarter_before_search_content_starts
14. spectrumstarter_after_search_content_ends
15. spectrumstarter_before_archive_content_starts
16. spectrumstarter_after_archive_content_ends
17. spectrumstarter_before_single_comment_starts
18. spectrumstarter_before_single_page_content_starts
19. spectrumstarter_after_single_page_content_ends

-- Generic hooks in all archive type pages (archive, category, tag, search) --
. spectrumstarter_before_general_archive_content_starts
. spectrumstarter_after_general_archive_content_ends
...
= Version 0.2 =
- New version of UIKit CSS Framework - v 2.27.2
- Updated FontAwesome Iconic fonts - v 4.7.0
- Minor Fixes
